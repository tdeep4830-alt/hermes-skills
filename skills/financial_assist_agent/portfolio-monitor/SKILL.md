...
## Commands
每日總結：
`python3 root/.hermes/scripts/portfolio_monitor.py --action daily-summary`

查看持倉：
`python3 root/.hermes/scripts/portfolio_monitor.py --action portfolio`

新增持倉：
`python3 root/.hermes/scripts/portfolio_monitor.py --action add --type stock --ticker AAPL --shares 10 --cost 180`
